...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/bookmarklet', [FrontendController::class, 'bookmarklet'])->name('front.bookmarklet');
    Route::get('/autofill-helper', [FrontendController::class, 'autofillHelper'])->name('front.autofillHelper');
});
